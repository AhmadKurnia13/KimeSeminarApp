...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivLogo,
      @NonNull LinearLayout layoutLogo, @NonNull TextView tvAppName, @NonNull TextView tvTagline) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, ivLogo, layoutLogo, tvAppName,
          tvTagline);
    }
