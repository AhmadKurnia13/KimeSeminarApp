...
public final class FragmentScheduleBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvSeminars;

  private FragmentScheduleBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView rvSeminars) {
    this.rootView = rootView;
    this.rvSeminars = rvSeminars;
  }
  ...
  public static FragmentScheduleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rvSeminars;
      RecyclerView rvSeminars = ViewBindings.findChildViewById(rootView, id);
      if (rvSeminars == null) {
        break missingId;
      }

      return new FragmentScheduleBinding((LinearLayout) rootView, rvSeminars);
    }
